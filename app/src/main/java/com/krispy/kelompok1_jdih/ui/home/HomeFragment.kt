 ...
 */
class HomeFragment : Fragment(), BeritaClickListener, DokumenClickListener {
    ...
    private fun setupVideoView() {
        ...
        val videoUri = Uri.parse("android.resource://" + requireActivity().packageName + "/" + R.raw.opening) // Replace with your video URI
